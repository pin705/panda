...
namespace App\Http\Controllers\Admin\Sworder;
 ...
 * @package App\Http\Controllers\Admin\Sworder
 */
class SworderController extends Controller
{

    static $views = 'admin.sworder.';

    /**
     * 首页
     * get: /admin/sworder/index
     */
    ...
    public function searchPage()
    {
        ...
        $list = $sql->where('m.name','<>',null)
            ...
            ->select('m.id as m_id','m.nickname','m.name','o.price','o.num','m.wx','m.zfb',
                'o.status','o.title','o.desc','o.id','o.name as o_name','.o.tel as o_tel','o.address as o_address',
