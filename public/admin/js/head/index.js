...
$(function () {
    table = $('#headTable').DataTable({
        ...
        "columns": [
            ...
            {
                "data": "head", "sClass": "text-center", "width": "8%",
            ...
            },
            {
                ...
                "render": function (data, type, full) {
                    var btns = [];
                    var editBtn ='<a href="javascript:;"  onclick="update(\'/admin/head/update?id='+data+'\');return false;" title="编辑" class="btn default btn-xs"><i class="fa fa-edit"></i>编辑</a>';
                    btns.push(editBtn);
