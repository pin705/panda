...
$(function () {
    table = $('#exchangeTable').DataTable({
        ...
        "columns": [
            ...
            {"data": "title", "sClass": "text-center", "width": "8%"},
            {"data": "desc", "sClass": "text-center", "width": "10%"},
            {"data": "stock", "sClass": "text-center", "width": "5%"},
            {"data": "price", "sClass": "text-center", "width": "5%",
                "render":function(data,type,full){
                    return data / 1000;
                }
            },
            {
                "data": "img", "sClass": "text-center", "width": "5%",
                "render": function (data, type, full) {
            ...
            {"data": "status","sClass" : "text-center","width":"8%",
                "render":function( data, type, full){
                    if(data == 2)
                        return ' <span class="label label-sm label-danger"> 虚拟物 </span>';
                    else if(data == 1)
                        return '<span class="label label-sm label-success"> 实物 </span>';
                    return "";
                },
            },
            {
                ...
                "render": function (data, type, full) {
                    var btns = [];
                    var editBtn ='<a href="javascript:;"  onclick="update(\'/admin/exchange/update?id='+data+'\');return false;" title="编辑" class="btn default btn-xs"><i class="fa fa-edit"></i>编辑</a>';
                    btns.push(editBtn);
