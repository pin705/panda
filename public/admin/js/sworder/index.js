...
$(function () {
    table = $('#sworderTable').DataTable({
        ...
        "columns": [
            ...
            {"data": "o_name", "sClass": "text-center", "width": "10%"},
            {"data": "o_tel", "sClass": "text-center", "width": "10%"},
            {"data": "o_address", "sClass": "text-center", "width": "10%"},
...
function getExcel(){
    window.location.href="/admin/xnorder/getExcel";
}
