...
var Game = (function (_super) {
    function Game() {
                    ...
                    if (data.length != 0) {
                        ...
                        function onMouse_zhitui(e, index) {
                            if (e.type == "click") {
                                if (e.target.name == "详情") {
                                    $.ajax({
                                        url: "/home2/personalDirectDetailh5",
                                        type: "POST",
                                        data: {
        ...
        this.denglu_box.getChildByName("登录").getChildByName("注册按钮").on(Laya.Event.MOUSE_DOWN, this, function () {
            ...
            this.denglu_box.getChildByName("注册").visible = true;
        });
    ...
    //购买方法 中  国 源码 网   w ww . z g ymw.com
    _proto.goumaifun = function () {
        if (jinbinum >= guoshu_jinbi) {
            $.ajax({
                url: "/home2/buyGoodsh5",
                type: "POST",
                data: {
