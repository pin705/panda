<?php $__env->startSection('title','兑换管理'); ?>
...
<?php $__env->startSection('titlename','兑换列表'); ?>
                ...
                <div class="ibox float-e-margins">
                    <div class="ibox-title">
                        <div class="row">
                            ...
                            <div class="col-lg-1">
                                <a href="javascript:" onclick="update('/admin/exchange/update?id=');return false;" class="btn btn-success">添加兑换奖品</a>
                            </div>
                        </div>
                    </div>
                    <div class="ibox-content">
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover" id="exchangeTable">
                                <thead>
                                <tr>
                                    <th>序号</th>
                                    <th>名称</th>
...
<?php $__env->startSection('js'); ?>
    ...
    <script src="<?php echo e(config('oss.AdminOssUrl')); ?>/admin/js/exchange/index.js"></script>
<?php $__env->stopSection(); ?>
