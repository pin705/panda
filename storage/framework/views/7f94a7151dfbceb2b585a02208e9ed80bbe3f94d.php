...
<script src="js/ui/layaUI.max.all.js?112"></script>
<script src="js/LayaSample.js?112"></script>
<script src="js/Game.js?112"></script>
<!--jsfile--endTag-->
</body>
...
<script type="text/javascript">
    var base_url = '<?php echo e(Config::get('custom.BasePath')); ?>'
    function zhifu(id,member_id) {
        window.location.href=base_url+"/home/pay?id="+id+"&mid="+member_id
    }
</script>
