				...
				<div class="ibox float-e-margins">
					...
					<div class="ibox-content">
						...
						<div class="table-responsive">
							<table class="table table-striped table-bordered table-hover" id="xnorderTable">
								<thead>
								<tr>
									<th>序号</th>
									<th>用户ID</th>
...
<?php $__env->startSection('js'); ?>
	...
	<script src="<?php echo e(config('oss.AdminOssUrl')); ?>/admin/js/xnorder/index.js"></script>
<?php $__env->stopSection(); ?>
