...
<head>
    ...
    <title>@if(config('backInfo.IS_WEB_TITLE_UNIFIED') == 0) @section('title') {{config('backInfo.WEB_TITLE')}} @show @else {{Session::get(config('custom.AdminUser'))['title']}} @endif </title>
