    ...
    <div class="modal-body">
        ...
        <div class="form-body">
            <div class="form-group">
                ...
                <div class="col-md-5">
                    <input type="text" value="@if(!empty($data)){{$data->nickname}}@endif" name="nickname" placeholder="昵称" class="form-control" />
                </div>
            </div>
            <div class="form-group">
                <label class="control-label col-md-4">密码： </label>
                <div class="col-md-5">
                    <input type="text" value="" name="pwd" placeholder="包含数字字母长度6-15位" class="form-control" />
                </div>
            </div>
        </div>
    </div>
